...
\graphicspath{{../../thesis_report/figures/}{../eda/figures/}{../modeling/figures/}{../dashboard/screenshots/}}
...
\begin{titlepage}
    ...
    \vfill
    \IfFileExists{../../thesis_report/figures/university_logo.png}{\includegraphics[width=0.24\textwidth]{../../thesis_report/figures/university_logo.png}\\[0.6cm]}{}
...
\include{chapters/03_data_and_study_design}
\include{chapters/04_methodology}
\include{chapters/05_results_and_discussion}
\include{chapters/06_dashboard}
\include{chapters/07_conclusion}

\appendix
\include{appendices/literature_matrix}
\include{appendices/model_details}
\include{appendices/research_paper_attachment}
