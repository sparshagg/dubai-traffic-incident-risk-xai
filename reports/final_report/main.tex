...
\newcommand{\publicrepo}{\url{https://github.com/sparshagg/thesis}}
...
\begin{titlepage}
    ...
    \vfill
    \IfFileExists{assets/university_logo.png}{\includegraphics[width=0.24\textwidth]{assets/university_logo.png}\\[0.6cm]}{}
